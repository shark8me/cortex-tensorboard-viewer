(ns cortex-tensorboard-viewer.tensorboard-test
  (:require [clojure.java.io :as io]
            ...
            [cortex-tensorboard-viewer.core :as ctv]))
...
(defn- train-and-eval
  ...
  (let [epoch-count 5
        metrics-chan (chan 20 (ctv/scalar-event-xform "metrics/"))
        event-writer-chan (ctv/tf-event-sink log-file metrics-chan epoch-count)
